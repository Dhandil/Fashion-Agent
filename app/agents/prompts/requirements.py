...
12. avoided_styles、avoided_colors 和 avoided_materials 只记录用户当前轮明确
    表达要避免的风格、颜色和材质；不得从历史对话、长期档案或常识猜测。
13. 当前轮明确避免某项时，不要同时把同一项放入对应的喜欢列表；例如用户说
    “平时喜欢黑色，但这次不要黑色”，本轮 avoided_colors 包含黑色，
